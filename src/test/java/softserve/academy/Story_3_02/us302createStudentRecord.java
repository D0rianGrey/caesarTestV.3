...
public class us302createStudentRecord {
    ...
    @Test(dataProvider = "provideStudentData", groups = {"createStudentsList"}, description = "User story 3-02:  Coordinator is on the “Group” page -> " +
    ...
    @AfterMethod(groups = {"createStudentsList"})
